...
var queryChaincode = async function(peer, channelName, chaincodeName, args, fcn, username, org_name,count) {
	let client = null;
	let channel = null;
	try {
		...
		if (response_payloads) {
			logger.info(' now has======== ' + response_payloads[0].toString('utf8'));
			return(JSON.parse(response_payloads[0].toString()));
		} else {
